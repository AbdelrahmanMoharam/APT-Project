...
public class Operation
{
    ...
    public static Operation createFormatChar(PositionID blockId, PositionID charId, CRDT.FormatType format) {
    ...
    public CRDT.FormatType getFormat() { return format; }
