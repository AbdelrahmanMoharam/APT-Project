...
public class InsertOp extends Operation {
    ...
    public InsertOp(String sessionId,
                    String userId,
                    long timestamp,
                    String blockId,
                    String nodeId,
    ...
    public void apply(Document document) {
        ...
        Block block = document.getBlockCRDT().getOrCreateBlock(blockId);
        block.getCharTree().insert(nodeId, parentId, value, bold, italic);
    }
    ...
    public static InsertOp fromPayload(String sessionId, String userId, long timestamp, JsonNode payload) {
        ...
        return new InsertOp(sessionId, userId, timestamp, blockId, nodeId, parentId, value, bold, italic);
    }
