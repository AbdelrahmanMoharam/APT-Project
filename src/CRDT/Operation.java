...
public class Operation {
    ...
    public static Operation createInsertBlock(PositionID blockId, String initialContent) {
        return new Operation(OpType.INSERT_BLOCK, blockId, null, initialContent, null);
    }

    public static Operation createDeleteBlock(PositionID blockId) {
        return new Operation(OpType.DELETE_BLOCK, blockId, null, null, null);
    }
    ...
    /**
     * Getter/Setter for inverseData (Crucial for Member 4's Undo/Redo task)
     */
